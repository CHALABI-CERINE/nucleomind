...
const i18n = {
  fr: {
    ...
    d2e5_title: "Nuit blanche 🌙",         d2e5_desc: "Pour les plus braves : finalisation nocturne avec ravitaillement continu.",
    ...
    d3e3_title: "Pitch Day 🎤",            d3e3_desc: "Chaque équipe présente sa solution devant le jury d'experts.",
  ...
  en: {
    ...
    d2e5_title: "All-Nighter 🌙",             d2e5_desc: "For the bravest: overnight finalisation with continuous supply.",
    ...
    d3e3_title: "Pitch Day 🎤",               d3e3_desc: "Each team presents their solution to the expert jury.",
